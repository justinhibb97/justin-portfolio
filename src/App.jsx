        ...
        <div className="home">
          ...
          <div id="contact" className="contact-section">
            ...
            <div className="contact-links">
              ...
              <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="contact-item fade-in" style={{ animationDelay: '0.4s' }}>
                <svg className="contact-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor">
              ...
              <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="contact-item fade-in" style={{ animationDelay: '0.6s' }}>
                <svg className="contact-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor">
